...
{
 // your code goed here
 byte substringvalue = httpHeader.indexOf('?',0);
 String getheader = httpHeader.substring(substringvalue+1);

  byte subsubstringvalue = getheader.indexOf('=',0);
  a = getheader.substring(1,subsubstringvalue).toInt();
  v = getheader.substring(subsubstringvalue+1).toInt();
